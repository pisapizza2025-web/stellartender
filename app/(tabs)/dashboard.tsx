...
import { estimateSavings, formatPercent } from '@/lib/payments/fees';
...
export default function DashboardScreen() {
  ...
  const feeBps = settings?.platform_fee_bps ?? 30;
  ...
  return (
    <Screen contentClassName="gap-5 pt-safe-offset-4">
      ...
      >
        ...
        <DetailRow label="Alternative payments processed" value={formatGbp(month.volume)} />
        <DetailRow label="Estimated traditional card fees" value={formatGbp(month.cardFees)} />
        <DetailRow label="Alternative Stellar Payment fees" value={formatGbp(month.altFees)} />
