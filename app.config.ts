...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  return {
    ...
    ios: {
      ...
      supportsTablet: true,
      bundleIdentifier: process.env.BILT_IOS_BUNDLE_ID ?? 'me.bilt.stellartender',
    },
    android: {
      package: process.env.BILT_ANDROID_PACKAGE ?? 'me.bilt.stellartender',
    },
    web: {
      bundler: 'metro',
